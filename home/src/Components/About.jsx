    ...
    render() {
        ...
        return (
            <section id="container-about" className="container-about">
                    ...
                    <h2 style={{display: 'inline', paddingRight: '50px'}}>Primary Language:</h2> 
                    <p style={{display: 'inline'}}>{ this.props.lang === "" ? "English" : this.props.lang} </p>
                    <br></br>
                    <br></br>
                    <h2 style={{display: 'inline', paddingRight: '50px'}}>Email:</h2> 
                    {
                    ...
                    <br></br>
                    {
                        (this.props.tutor) ? <><h2 style={{display: 'inline', paddingRight: '50px'}}>Price:</h2><p style={{display: 'inline'}}>${this.props.price}/hour</p> 
                        <br></br>
                        <br></br>
                        <h2 style={{display: 'inline', paddingRight: '50px'}}>Tutor Rating:</h2><p style={{display: 'inline'}}>{this.props.tutorRating}/5.0</p>
                        </>
                        : <span></span>
                    }
