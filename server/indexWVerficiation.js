//libraries
//------------------------DONT USE THIS FILE-------------------------------
//------------------------FILE EXISTS FOR JHARNA REFERENCE FOR FINAL INTEGRATION OF EMAIL VERIFICATION-------------------
//reasoning: email verification or the packages that were installed for the verification causes external errors which are causing
//the create account to not work. this file will be used to retrieve code for email verification after more impending funcitonalities
//have been integrate and we are ready to debug this functionality.
...
app.post('/signup', async(req, res) => {
    ...
    /*this is for email verification, uncomment below when ready to */
    //const userResponse = 
